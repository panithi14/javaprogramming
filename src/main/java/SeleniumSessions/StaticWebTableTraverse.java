...
public class StaticWebTableTraverse {
	...
	/*
	 * IQ how to print the entire web table
	 * 
	 * we have to find out the pattern and break the pattern into two parts and then start looping 
	 * 
	 * we can use following nd preceding siblings also 
	 * 
	 */
