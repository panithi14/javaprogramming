...
public class Employee {
	...
	public static void main(String[] args) {
		...
		//properties -- config.properties --> <key, value> -- pair -- set
				...
				HashMap<String, String> empMap = new LinkedHashMap<String, String>();
				
				//LinkedHapMap will maintain the order and hashMap will not maintain the order
				...
				//we can not maintain duplicate keys for different values 
